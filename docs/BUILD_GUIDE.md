...
* Output: `sd-gundam-g-generation-zh.nds`, 30,359,400 B, sha1
  `7a2d5a647fbc3a461fff1892d23e309d3fb2dec1`; with `--pad32m` also the 32 MiB 0xFF-padded
  image (sha1 `0dcd0422828db22c0fbdcf7aa4cacd5408ddecf2`). (`data/manifest.json` is the
