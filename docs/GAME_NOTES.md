...
| **Tile-graphic text** (not strings) | title/bonus menus, BackStage tabs/submenus, settings, battle START menu, force-HUD, terrain badges, captain badge | `42d.bin`, `3d3`–`3d7.bin`, `3e3.bin`, `3e4.bin`, arm9 `0x168598..0x169338`, `478.bin`, `48a.bin`, `388.bin` | repainted/repacked as graphics inside original resource capacities |
